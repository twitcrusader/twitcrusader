...
void startCreditsDialog()
{
	...
	GError* error = NULL;
	gtk_window_set_icon_from_file (GTK_WINDOW (dialog), ICONS_DIR""ICON_FAVICON, &error);
	...
	gtk_about_dialog_set_copyright (GTK_ABOUT_DIALOG (dialog), g_markup_escape_text(copyright, strlen(copyright)));
