...
void windows_adduser()
{
	...
	gtk_window_set_icon_from_file (GTK_WINDOW(window), PACKAGE_PIXMAP_DIR"/add_user.png", &error);

	// Table Content Input
	table = gtk_table_new (10, 10, TRUE);

	twitter_login = gtk_image_new_from_file (PACKAGE_PIXMAP_DIR"/sign-in-with-twitter.png");
